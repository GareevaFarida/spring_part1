...
public class ProductService {
    ...
    @Transactional(readOnly = true)
    public List<ProductRepr> filterProducts(ProductFilter productFilter) {
        return productRepository.filterProducts(productFilter.getCategoryId(),productFilter.getPriceMin(),productFilter.getPriceMax());
    }
